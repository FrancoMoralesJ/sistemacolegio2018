...
public class Acerca extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Software que ayuda a agelizar  la elaboracionn de Matricula/Pagos/Notas");

        jLabel3.setText("con un metodo eficaz y durable");
        ...
        jLabel8.setText("ID de Desarrollo ");

        jLabel9.setText("Web");

        jLabel10.setText("Version 1.2");

        jLabel11.setText("Windows  Xp/Vista/Windows Seven");

        jLabel12.setText("MySql");

        jLabel13.setText("Netbenas  8.2");

        jLabel15.setText("www.Educando.com");

        jLabel16.setText("Reportes");

        jLabel17.setText("Ireportes 3.5 ");
